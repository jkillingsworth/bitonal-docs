...
let private stringToPixels value =
    value
    |> Seq.map (fun i -> if i = '0' then Black else White)
    |> Seq.toArray

let private stringFromBits value =
    value
    |> Seq.map (fun i -> if i = Bit0 then '0' else '1')
    |> Seq.toArray
    |> (fun x -> new string(x))

let private testGroup3OneDimensional scanline =
    scanline
    |> stringToPixels
    |> Group3OneDimensional.compress
    |> stringFromBits
    |> should equal

[<Test>]
let ``Group 3 one dimensional, compression works correctly`` () =

    let expected = "00110101" + "10" + "000111" + "11" + "0111" + "010" + "1000"
    let scanline = "000100110111"
    testGroup3OneDimensional scanline expected

[<Test>]
let ``Group 3 one dimensional, empty sequence of 0`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 1`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 2`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 3`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 63`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 64`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 65`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 700`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching black sequence of 7000`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 1`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 2`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 3`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 63`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 64`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 65`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 700`` () =
...
[<Test>]
let ``Group 3 one dimensional, matching white sequence of 7000`` () =
...
let ``Pack bits, compression works correctly`` () =
    ...
    let result = PackBits.compress scanline
    let expected =
        [| 0xFEuy; 0xAAuy;
